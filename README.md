...
bounded version 1 event-group, persona, and binding validation, and a bounded
persona-prompt file reader are in place. Validation and assembly for the
remaining configuration categories, observation
