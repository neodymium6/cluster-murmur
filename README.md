...
in place. The bounded version 1 event-matcher grammar and event-trigger category
validation are also implemented. Schedule and stochastic trigger validation,
complete configuration assembly, observation ingestion, persistence, trigger
